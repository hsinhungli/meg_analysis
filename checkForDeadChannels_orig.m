function output = checkForDeadChannels_orig(sqdFile)
...
% Use a blocksize of 100k (which is 100 seconds for 1kHz sampling rate or
% 200s at 500Hz).
...
[~,clipChannelEnd] = find(diffOfClips== -1);
[~,clipChannelBegin] = find(diffOfClips== 1);
