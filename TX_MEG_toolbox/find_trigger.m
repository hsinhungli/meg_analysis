...
threshold = (25-1) /info.InputGain *1200;%50;%2;  % 3.29.2012   change the threshold from *50 to *250
%threshold = (25-1) /info.InputGain *1;%2;%2;
...
%trigger=trigger(size(trigger,1)-4:size(trigger,1),:);